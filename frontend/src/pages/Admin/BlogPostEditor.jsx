...
const BlogPostEditor = ({ isEdit }) => {
  ...
  const generatePostIdeas = async () => {
    ...
    try {
      ...
      const generateIdeas = aiRes.data;
    ...
    <DashboardLayout activeMenu="Blog Posts">
      <div className="my-5">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 my-4">
          ...
          {!isEdit && (
            <div className="form-card col-span-12 md:col-span-4 p-6 flex flex-col justify-between">
              <div className="flex items-center justify-between">
                ...
                <button
                  className="bg-gradient-to-r from-sky-500 to-cyan-400 font-semibold text-[13px] text-white px-3 py-1 rounded hover:bg-black hover:text-white transition-colors cursor-pointer hover:shadow-2xl hover:shadow-sky-200"
                  onClick={() => {
