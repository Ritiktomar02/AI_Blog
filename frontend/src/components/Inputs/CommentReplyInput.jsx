      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center justify-end gap-4">
            <button className="flex items-center gap-1.5 text-[14px] font-medium text-gray-500 bg-gray-100 px-4 py-0.5 rounded-full hover:bg-gray-800 hover:text-white cursor-pointer " disabled={loading} onClick={handleCancelReply}>
              Cancel
            </button>
        ...
        {!disableAutoGen && (
          <button className="flex items-center gap-1.5 text-[13px] font-medium text-sky-500 bg-sky-50 px-4 py-0.5 rounded-full hover:bg-sky-500 hover:text-white cursor-pointer absolute top-0 right-0" disabled={loading} onClick={generateReply}>
            {loading ? (
