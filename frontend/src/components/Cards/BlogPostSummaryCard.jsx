    ...
    >
      ...
      <div className="flex-1">
        ...
        <div className="flex items-center gap-2.5 mt-2 flex-wrap">
          <div className="text-[11px] text-gray-700 font-medium bg-gray-100 px-2 py-0.5 rounded">
            Updated: {updatedOn}
          </div>
      ...
      <button
        className="hidden md:group-hover:flex items-center gap-2 text-xs font-medium text-rose-500 bg-rose-50 px-3 py-1 rounded text-nowrap border border-rose-100 hover:border-rose-200 cursor-pointer"
        onClick={(e) => {
          e.stopPropagation();
          onDelete();
        }}
      >
        <LuTrash2 className="hidden md:block" /> <span>Delete</span>
      </button>
    </div>
  );
};
